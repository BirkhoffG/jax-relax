  ...
  'syms': { 'relax.data.loader': { 'relax.data.loader.ArrayDataset': ('data.loader.html#arraydataset', 'relax/data/loader.py'),
            ...
            'relax.methods.cchvae': { 'relax.methods.cchvae.CCHVAE': ('cchvae.html#cchvae', 'relax/methods/cchvae.py'),
                                      ...
                                      'relax.methods.cchvae.CHVAE.validation_step': ( 'cchvae.html#chvae.validation_step',
                                                                                      'relax/methods/cchvae.py'),
                                      'relax.methods.cchvae.CHVAEConfigs': ('cchvae.html#chvaeconfigs', 'relax/methods/cchvae.py'),
                                      ...
                                      'relax.methods.cchvae._cchvae_generate': ('cchvae.html#_cchvae_generate', 'relax/methods/cchvae.py'),
                                      'relax.methods.cchvae._hyper_sphere_coordindates': ( 'cchvae.html#_hyper_sphere_coordindates',
                                                                                           'relax/methods/cchvae.py')},
