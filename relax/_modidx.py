...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'relax.base': { 'relax.base.BaseConfig': ('base.html#baseconfig', 'relax/base.py'),
            ...
            'relax.legacy.utils': { 'relax.legacy.utils.Config': ('legacy/utils.html#config', 'relax/legacy/utils.py'),
                                    ...
                                    'relax.legacy.utils._reshape_x': ('legacy/utils.html#_reshape_x', 'relax/legacy/utils.py'),
                                    'relax.legacy.utils.accuracy': ('legacy/utils.html#accuracy', 'relax/legacy/utils.py'),
                                    'relax.legacy.utils.auto_reshaping': ('legacy/utils.html#auto_reshaping', 'relax/legacy/utils.py'),
            ...
            'relax.methods.counternet': { 'relax.methods.counternet.CounterNet': ( 'methods/counternet.html#counternet',
                                          ...
                                          'relax.methods.counternet.CounterNetModel.exp_loss_fn': ( 'methods/counternet.html#counternetmodel.exp_loss_fn',
                                                                                                    'relax/methods/counternet.py'),
                                          'relax.methods.counternet.CounterNetModel.freeze_predictor': ( 'methods/counternet.html#counternetmodel.freeze_predictor',
                                                                                                         'relax/methods/counternet.py'),
                                          'relax.methods.counternet.CounterNetModel.pred_loss_fn': ( 'methods/counternet.html#counternetmodel.pred_loss_fn',
                                                                                                     'relax/methods/counternet.py'),
                                          'relax.methods.counternet.CounterNetModel.stateless_forward': ( 'methods/counternet.html#counternetmodel.stateless_forward',
                                                                                                          'relax/methods/counternet.py'),
